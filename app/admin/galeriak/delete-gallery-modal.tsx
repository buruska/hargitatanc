...
import { deletePerformanceGalleryAction, type DeleteGalleryState } from "./actions";
...
const initialState: DeleteGalleryState = {};

export function DeleteGalleryModal({ id, title }: DeleteGalleryModalProps) {
  const [state, formAction, isPending] = useActionState(deletePerformanceGalleryAction, initialState);
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-charcoal/60 px-4 py-8" role="presentation">
          ...
          >
            ...
            <p className="text-muted">
              Biztosan törölni akarod ennek a darabnak a galériaképeit?
            </p>
