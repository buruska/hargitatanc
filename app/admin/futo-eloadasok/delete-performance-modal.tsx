...
import { deleteRunningPerformanceAction, type DeletePerformanceState } from "./actions";
...
const initialState: DeletePerformanceState = {};

export function DeletePerformanceModal({ id, title }: DeletePerformanceModalProps) {
  const [state, formAction, isPending] = useActionState(deleteRunningPerformanceAction, initialState);
