...
import { createRunningPerformanceAction, type PerformanceFormState } from "./actions";

const initialState: PerformanceFormState = {};

export function NewPerformanceModal() {
  const [state, formAction, isPending] = useActionState(createRunningPerformanceAction, initialState);
